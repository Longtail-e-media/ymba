...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.pdf.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.pdf.php?action=sort",
...
$(document).ready(function(){	
	...
	jQuery('#pdf_frm').validationEngine({
		autoHidePrompt:true,
		scroll: true,
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>pdf/list";},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>pdf/addEdit";},3000);						   	
						   if(actionId==0)
...
{
	window.location.href="<?php echo ADMIN_URL?>pdf/list";
}

/***************************************** Add New pdfs *******************************************/
function AddNewpdf()
{
	window.location.href="<?php echo ADMIN_URL?>pdf/addEdit";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>pdf/addEdit/"+Re;
}

// Navigation Child List
function viewsublist(Re)
{
	window.location.href= "<?php echo ADMIN_URL?>pdf/list/"+Re;
}
...
function deleteSavepdfimage(Re)
{
