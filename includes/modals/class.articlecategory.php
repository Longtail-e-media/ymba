<?php
class ArticleCategory extends DatabaseObject {

	protected static $table_name = "tbl_article_category";
	protected static $db_fields = array('id', 'title', 'slug', 'brief', 'status', 'sortorder', 'added_date', 'modified_date');
	...
	public static function get_allarticlecategory($limit=''){
		global $db;
...
//	public static function getAllArticleCategory($total=6, $offset=0){
//		global $db;
...
//	}
	...
	public static function getTotalArticleCategory(){
		global $db;
