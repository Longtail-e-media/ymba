...
class User extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'first_name', 'middle_name', 'last_name', 'contact', 'email', 'optional_email', 'username', 'password', 'accesskey', 'image', 'group_id', 'access_code', 'facebook_uid', 'facebook_accesstoken', 'facebook_tokenexpire', 'sortorder', 'status', 'added_date');
