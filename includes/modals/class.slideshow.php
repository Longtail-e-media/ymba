...
class Slideshow extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'title', 'image', 'linksrc', 'linktype', 'content', 'status', 'm_status', 'added_date', 'sortorder', 'type');
	...
	public static function getSlideshow_by(){
		global $db;
