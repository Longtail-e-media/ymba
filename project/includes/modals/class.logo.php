...
class Logo extends DatabaseObject
{

    protected static $table_name = "tbl_logo";
    protected static $db_fields = array('id', 'category_id', 'title', 'linktype', 'linksrc', 'image', 'status', 'sortorder', 'added_date');
    ...
    public static function find_by_category($cat_id = 0)
    {
        global $db;
        $result_array = self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE status=1 AND category_id={$cat_id} ORDER BY sortorder DESC");
        return $result_array;
    }
