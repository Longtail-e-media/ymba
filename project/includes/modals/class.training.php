...
class Training extends DatabaseObject
{

    protected static $table_name = "tbl_training";
    protected static $db_fields = array('id', 'title', 'pdf', 'given_to', 'date', 'date_to', 'status', 'sortorder');
    ...
    //GET ALL Pdf
    public static function get_allpdf($limit = '')
    {
        global $db;
    ...
    public static function getAllPdf()
    {
        global $db;
    ...
    // GET Pdf LIST.
    public static function getPdfList($total = 5)
    {
        global $db;
    ...
    // GET SPECIFIC Pdf
    public static function getPdf($id = 0)
    {
        global $db;
    ...
    public static function getTotalPdf()
    {
        global $db;
