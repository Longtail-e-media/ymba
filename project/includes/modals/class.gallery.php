...
class Gallery extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'slug', 'image', 'title', 'status', 'sortorder', 'detail', 'type', 'registered');
    ...
    {
        global $db;
        $sql = "SELECT * FROM " . self::$table_name . " WHERE status=1 AND id<>14 AND id<>19 ORDER BY sortorder ASC ";
