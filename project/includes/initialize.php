...
if ($online) {
    ...
    defined('BASE_URL') ? NULL : define('BASE_URL', $base_protocol . '://' . $_SERVER['HTTP_HOST'] . str_replace('::', '/', SITE_STR) . '/' . SITE_FOLDER . '/');
...
defined('SLIDESHOW_PATH') ? NULL : define('SLIDESHOW_PATH', IMAGE_PATH . 'slideshow/');
...
defined('HOTEL_ACCESS') ? NULL : define('HOTEL_ACCESS', BASE_URL . 'apanel/hotel/SWyTze');
