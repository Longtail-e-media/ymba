...
$moduleFoldername = "category";        // Image folder name
 ...
 <h3>
   ...
   <tbody>
                <?php $records = Category::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="category_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="title" id="title"
                               value="<?php echo !empty($categoryInfo->title) ? $categoryInfo->title : ""; ?>">
                    </div>
                </div>
                 <div class="form-row add-image">
                    ...
                    if (!empty($categoryInfo->image)) {
                        $imgRec = unserialize($categoryInfo->image);
                        if (is_array($imgRec)) {
                            foreach ($imgRec as $key => $recimg) {
                                $deleteid = rand(0, 99999);
                                $imagePath = SITE_ROOT . 'images/category/' . $recimg;
                                        ...
                                        <div class="infobox info-bg">
                                            <div class="button-group" data-toggle="buttons">
                                                <span class="float-left">
                                                    <?php
                                                    if (file_exists(SITE_ROOT . "images/category/" . $recimg)):
                                                        $filesize = filesize(SITE_ROOT . "images/category/" . $recimg);
                                                        echo 'Size : ' . getFileFormattedSize($filesize);
                                                    endif;
                                                    ?>
                                                </span>
                                                <a class="btn small float-right" href="javascript:void(0);"
                                                   onclick="deleteSavedCategoryimage(<?php echo $deleteid; ?>);">
                                                    <i class="glyph-icon icon-trash-o"></i>
                                                </a>
                                            </div>
                                            <img src="<?php echo IMAGE_PATH . 'category/thumbnails/' . $recimg; ?>"
                                                 style="width:100%"/>
				...
				<div class="form-row">
                    <div class="form-label col-md-12">
                        ...
                        <textarea name="content" id="content"
                            ...
                            <?php echo !empty($categoryInfo->content) ? $categoryInfo->content : ""; ?></textarea>
                ...
                <div class="form-row <?php echo (!empty($categoryInfo->meta_keywords) || !empty($categoryInfo->meta_description) || !empty($categoryInfo->meta_title)) ? '' : 'hide'; ?> metadata">
                    <div class="col-md-12">
                        <div class="form-input col-md-12">
                            <input placeholder="Meta Title" class="col-md-6 validate[required]" type="text"
                                   name="meta_title" id="meta_title"
                                   value="<?php echo !empty($categoryInfo->meta_title) ? $categoryInfo->meta_title : ""; ?>">
                        </div>
                        <br/>
                        <div class="form-input col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <textarea placeholder="Meta Keyword" name="meta_keywords" id="meta_keywords"
                                        ...
                                        <?php echo !empty($categoryInfo->meta_keywords) ? $categoryInfo->meta_keywords : ""; ?></textarea>
                                ...
                                <div class="col-md-6">
                                    <textarea placeholder="Meta Description" name="meta_description"
                                        ...
                                        <?php echo !empty($categoryInfo->meta_description) ? $categoryInfo->meta_description : ""; ?></textarea>
