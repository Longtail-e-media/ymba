            ...
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                            <small>Image Dimensions (1930 px X 380 px)
                            </small>
                        </label>
                    </div>
                    ...
                    if (!empty($articlesInfo->banner)) {
                        ...
                        if (is_array($imgRec)) {
                            foreach ($imgRec as $key => $recimg) {
                                ...
                                $imagePath = SITE_ROOT . 'images/articles/banner/' . $recimg;
                                        ...
                                        <div class="infobox info-bg">
                                            <div class="button-group" data-toggle="buttons">
                                                <span class="float-left">
                                                    <?php
                                                    if (file_exists(SITE_ROOT . "images/articles/banner/" . $recimg)):
                                                        $filesize = filesize(SITE_ROOT . "images/articles/banner/" . $recimg);
                                            ...
                                            <img src="<?php echo IMAGE_PATH . 'articles/banner/thumbnails/' . $recimg; ?>"
                                                 style="width:100%"/>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#banner_upload').uploadify({
                ...
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/articles/banner/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/articles/uploaded_banner.php', {imagefile: filename}, function (msg) {
