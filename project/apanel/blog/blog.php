            ...
            <form action="" class="col-md-12 center-margin" id="blog_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <input placeholder="e.g.(slug-example) and write roman words for nepali text" class="col-md-6 validate[required,length[0,200]]" type="text" name="slug" id="slug"
                ...
                <div class="form-row">
                    ...
                    <?php if (!empty($blogInfo->thumb_upload)): ?>
                        <div class="col-md-3" id="removeSavedThumbimg<?php echo $blogInfo->id; ?>">
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/blog/thumb/" . $blogInfo->thumb_upload)):
                                    $filesize = filesize(SITE_ROOT . "images/blog/thumb/" . $blogInfo->thumb_upload);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                    <a class="btn small float-right" href="javascript:void(0);"
                                       onclick="deleteSavedBlogThumbimage(<?php echo $blogInfo->id; ?>);">
                                        <i class="glyph-icon icon-trash-o"></i>
                                    </a>
                                </div>
                                <img src="<?php echo IMAGE_PATH . 'blog/thumb/thumbnails/' . $blogInfo->thumb_upload; ?>"
                                     style="width:100%"/>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div id="preview_thumb">
                        <input type="hidden" name="imageArrayname1" value="<?php echo !empty($blogInfo->thumb_upload) ? $blogInfo->thumb_upload : ""; ?>" class=""/></div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#thumb_upload').uploadify({
                ...
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/blog/thumb/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/blog/uploaded_thumb.php', {imagefile1: filename}, function (msg) {
                        $('#preview_thumb').append(msg).show();
                    });
