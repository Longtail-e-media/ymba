...
$_SESSION['imageNameArr1'][] = $_POST['imagefile1'];
$imageNameArr =  $_SESSION['imageNameArr1'];
$deleteid = rand(0,99999);
if(!empty($imageNameArr)):
foreach($imageNameArr as $key=>$val):?>
<div class="col-md-3" id="previewThumbUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'blog/thumb/thumbnails/'.$val;?>"  style="width:100%"/>
        <a href="javascript:void(0);" onclick="deleteTempThumbimage(<?php echo $deleteid;?>);">
...
//uplodify
  if(isset($_SESSION['imageNameArr1'])){
   if(count($_SESSION['imageNameArr1'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'blog/thumb/thumbnails'.$val);
      	 @unlink(IMAGE_PATH.'blog/thumb/'.$val);
      }	 
