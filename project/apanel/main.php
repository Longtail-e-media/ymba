...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link id="layout-theme" rel="stylesheet" type="text/css"
          href="<?php echo ASSETS_PATH; ?>themes/minified/agileui/color-schemes/layouts/default.min.css">
    <link id="elements-theme" rel="stylesheet" type="text/css"
          href="<?php echo ASSETS_PATH; ?>themes/minified/agileui/color-schemes/elements/default.min.css">
    <!-- AgileUI Responsive -->
    ...
    <!-- jQuery -->
    <noscript>This site has features that require javascript. Follow these simple instructions to <a
                href="http://www.activatejavascript.org" target="_blank">enable JavaScript in your web browser</a>.
    </noscript>
    ...
    <!-- Data Table -->
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>Datatable/media/css/demo_table_jui.css" type="text/css"
          media="screen"/>
    ...
    <script type="text/javascript"
            src="<?php echo ASSETS_PATH; ?>Datatable/media/js/jquery.dataTables.rowReordering.js"></script>
    ...
    <!-- Fancybox -->
    <script type="text/javascript"
            src="<?php echo ASSETS_PATH; ?>fancybox/lib/jquery.mousewheel-3.0.6.pack.js"></script>

    <!-- Add fancyBox main JS and CSS files -->
    <script type="text/javascript" src="<?php echo ASSETS_PATH; ?>fancybox/source/jquery.fancybox.js?v=2.1.5"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo ASSETS_PATH; ?>fancybox/source/jquery.fancybox.css?v=2.1.5"
          media="screen"/>

    <!-- Add Button helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
          href="<?php echo ASSETS_PATH; ?>fancybox/source/helpers/jquery.fancybox-buttons.css?v=1.0.5"/>
    <script type="text/javascript"
            src="<?php echo ASSETS_PATH; ?>fancybox/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>

    <!-- Add Thumbnail helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
          href="<?php echo ASSETS_PATH; ?>fancybox/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7"/>
    <script type="text/javascript"
            src="<?php echo ASSETS_PATH; ?>fancybox/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>

    <!-- Add Media helper (this is optional) -->
    <script type="text/javascript"
            src="<?php echo ASSETS_PATH; ?>fancybox/source/helpers/jquery.fancybox-media.js?v=1.0.6"></script>
<script src="<?php echo BASE_URL; ?>template/cms/js/scripts.js"></script>
    <!-- End links -->
    <style type="text/css">
        .divMessageBox {
            width: 100%;
    ...
    <link rel="apple-touch-icon" sizes="72x72"
          href="<?php echo IMAGE_PATH . 'preference/' . $siteRegulars->icon_upload; ?>">
                ...
                <div id="page-header-wrapper" class="clearfix">
                    <div class="top-icon-bar dropdown">
                        <a href="javascript:void(0);" title="" class="user-ico clearfix" data-toggle="dropdown">
                            <img width="75" alt="<?php echo $siteRegulars->sitetitle; ?>"
                                 src="<?php echo IMAGE_PATH . 'preference/' . $siteRegulars->logo_upload; ?>">
                            <span><?php echo $session->get('loginUser'); ?></span>
                            <i class="glyph-icon icon-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu float-right">
                            <li>
                                <a href="<?php echo BASE_URL; ?>" title="<?php Config::getField('sitename'); ?>"
                                   target="_blank">
                    ...
                    <div class="top-icon-bar">
                        ...
                        <?php if (!empty($siteRegulars->linksrc)) { ?>
                            <a href="<?php echo $siteRegulars->linksrc; ?>" target="_blank" class="user-ico clearfix"
                               title="Google Analytics ">
                                <span>
                                    <i class="glyph-icon icon-sign-out font-size-12"
                                       style="margin: 0px !important;"></i> Google Analytics
                                </span>
                            </a>
                        <?php } ?>
                    </div>
...
<script type="text/javascript">
    var isFlashInstalled = (function () {
        var b = new function () {
            var n = this;
            n.c = !1;
            var a = "ShockwaveFlash.ShockwaveFlash", r = [{
                name: a + ".7", version: function (n) {
                    return e(n)
                }
            }, {
                name: a + ".6", version: function (n) {
                    var a = "6,0,21";
                    try {
            ...
            n.b = function () {
                if (navigator.plugins && navigator.plugins.length > 0) {
                    var a = "application/x-shockwave-flash", e = navigator.mimeTypes;
                    e && e[a] && e[a].enabledPlugin && e[a].enabledPlugin.description && (n.c = !0)
                } else if (-1 == navigator.appVersion.indexOf("Mac") && window.execScript) for (var t = -1, c = 0; c < r.length && -1 == t; c++) {
                    var o = i(r[c].name);
