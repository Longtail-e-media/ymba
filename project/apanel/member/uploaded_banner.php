...
<div class="col-md-3" id="previewUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'member/banner/thumbnails/'.$val;?>"  style="width:100%"/>
...
//uplodify
  if(isset($_SESSION['imageNameArr1'])){
   if(count($_SESSION['imageNameArr1'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'member/banner/thumbnails/'.$val);
      	 @unlink(IMAGE_PATH.'member/banner/'.$val);
      }	 
