...
$moduleFoldername = "member";        // Image folder name
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $articlesInfo = Member::find_by_id($articlesId);
    ...
    $articlecategories = ArticleCategory::get_allarticlecategory();
    ?>
    <h3>
            ...
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <!--<div class="form-row menu-position">
                    ...
                    <div class="form-input col-md-3">
                        <select data-placeholder="None" class="validate[]" id="category_id" name="category_id">
                            ...
                            <?php foreach ($articlecategories as $key => $val) {
                                $sel = (!empty($articlesInfo->category_id) and $articlesInfo->category_id ==$val->id)?'selected':'';
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                            <small>Image Dimensions (350 px X 350 px)
                            </small>
                        </label>
                    </div>
                    <!-- Upload user image preview -->
                    <div id="preview_Banner"><input type="hidden" name="imageArrayname1[]"/></div>
                    <?php
                    if (!empty($articlesInfo->banner)) {
                        $imgRec = unserialize($articlesInfo->banner);
                        if (is_array($imgRec)) {
                            foreach ($imgRec as $key => $recimg) {
                                $deleteid = rand(0, 99999);
                                $imagePath = SITE_ROOT . 'images/member/banner/' . $recimg;
                                        ...
                                        <div class="infobox info-bg">
                                            <div class="button-group" data-toggle="buttons">
                                                <span class="float-left">
                                                    <?php
                                                    if (file_exists(SITE_ROOT . "images/member/banner/" . $recimg)):
                                                        $filesize = filesize(SITE_ROOT . "images/member/banner/" . $recimg);
                                            ...
                                            <img src="<?php echo IMAGE_PATH . 'member/banner/thumbnails/' . $recimg; ?>"
                                                 style="width:100%"/>
                ...
                if (!empty($articlesInfo->image)) {
                    ...
                    if (is_array($imgRec)) {
                        foreach ($imgRec as $key => $recimg) {
                            $deleteid = rand(0, 99999);
                            $imagePath = SITE_ROOT . 'images/member/' . $recimg;
                            if (file_exists($imagePath)) { ?>
                                    <div class="col-md-3" id="removeSavedimg<?php echo $deleteid; ?>">
                                        <div class="infobox info-bg">
                                            <div class="button-group" data-toggle="buttons">
                                                <span class="float-left">
                                                    <?php
                                if (file_exists(SITE_ROOT . "images/member/" . $recimg)):
                                    $filesize = filesize(SITE_ROOT . "images/member/" . $recimg);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                                                </span>
                                            ...
                                            <img src="<?php echo IMAGE_PATH . 'member/thumbnails/' . $recimg; ?>"
                                                 style="width:100%"/>
                ...
                // Article Page Link
                echo Member::get_internal_link($Lpageview, $LinkTypeview);
                ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        ...
                        <textarea name="content" id="content"
                            ...
                            <?php echo !empty($articlesInfo->content) ? $articlesInfo->content : ""; ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <textarea placeholder="Meta Keyword" name="meta_keywords" id="meta_keywords"
                                              class="character-keyword validate[required]">
                                        <?php echo !empty($articlesInfo->meta_keywords) ? $articlesInfo->meta_keywords : ""; ?></textarea>
                                ...
                                <div class="col-md-6">
                                    <textarea placeholder="Meta Description" name="meta_description"
                                              id="meta_description"
                                              class="character-description validate[required]">
                                        <?php echo !empty($articlesInfo->meta_description) ? $articlesInfo->meta_description : ""; ?></textarea>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#banner_upload').uploadify({
                ...
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/member/banner/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/member/uploaded_banner.php', {imagefile: filename}, function (msg) {
