...
if (isset($_GET['page']) && $_GET['page'] == "gallery" && isset($_GET['mode']) && $_GET['mode'] == "galleryImageList"):
    ...
    <span class="glyph-icon icon-separator">
        ...
        $saveGallery = GalleryImage::find_by_sql("SELECT * FROM tbl_gallery_images WHERE galleryid='{$id}' ORDER BY sortorder DESC");
        if ($saveGallery):
            ?>
            <div class="row">
                ...
                <div class="form-row col-md-12">
                    ...
                    <div class="form-input col-md-6">
                        <input type="text" class="validate[required]"
                               placeholder="Youtube Link (eg. : https://www.youtube.com/watch?v=jWM0ct-OLsM)"
                               name="videolink">
                    </div>
                    <div class="form-input float-right">
                        <button type="submit" name="submit"
                        ...
                        <tr id="<?php echo $sgRow->id; ?>">
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:void(0);"
                                   ...
                                   status="<?php echo $sgRow->status; ?>" id="imgHolder_<?php echo $sgRow->id; ?>"
                                   moduleId="<?php echo $sgRow->id; ?>">
                                    <i class="glyph-icon icon-flag"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn small bg-red tooltip-button"
                                   data-placement="top" title="Remove"
                                   onclick="subrecordDelete(<?php echo $sgRow->id; ?>);">
