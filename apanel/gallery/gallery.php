...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"): ?>
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $vtype = ($galleryInfo->type == 1) ? "checked" : " ";
        $unvtype = ($galleryInfo->type == 0) ? "checked" : " ";
    endif;
    ?>
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" method="post" id="gallery_frm">
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader <?php echo !empty($galleryInfo->image) ? "hide" : ""; ?>">
                        ...
                        <label>
                            <small>Image Dimensions (1400 px X 500 px)</small>
                        </label>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-checkbox-radio col-md-9">
                        <input type="radio" class="custom-radio" name="type" id="check1"
                               value="1" <?php echo !empty($vtype) ? $vtype : "checked"; ?>>
                        <label for="">Image gallery</label>
                        <input type="radio" class="custom-radio" name="type" id="check0"
                               value="0" <?php echo !empty($unvtype) ? $unvtype : ""; ?>>
