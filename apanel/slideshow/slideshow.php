...
$position = array(1 => 'Top-align', 2 => 'Middle-align', 3 => 'Bottom-align');
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = Slideshow::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="slideshow_frm">
                ...
                //                                $sel = (!empty($advInfo->type) and $advInfo->type == $key) ? 'selected' : '';
