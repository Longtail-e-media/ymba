            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                foreach ($records as $key => $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        ...
                        <!--<td><?php echo ($record->type == 1) ? 'Cause' : 'Blog'; ?></td>-->
                               ...
                               onClick="viewreviewlist(<?php echo $record->id; ?>);" href="javascript:void(0);">
                                <span class="button-content">
                                    <span class="badge bg-orange radius-all-4 mrg5R" title=""
                                          data-original-title="Badge with tooltip"><?php echo $countImages = Review::getTotalSubApanel($record->id); ?></span>
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $external = ($eventsInfo->linktype == 1) ? "checked" : " ";
        $internal = ($eventsInfo->linktype == 0) ? "checked" : " ";

        $homepage = ($eventsInfo->homepage == 1) ? "checked" : " ";
        $nothomepage = ($eventsInfo->homepage == 0) ? "checked" : " ";
    ...
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit Event' : 'Add Event'; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);"
            ...
            <form action="" class="col-md-12 center-margin" id="events_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Title" class="col-md-6 validate[required,length[0,250]]" type="text"
                               name="title" id="title"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-12">
                        <div class="col-md-4">
                            <input placeholder="Date" type="text" name="event_stdate" id="event_stdate"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="By" class="col-md-6 validate[length[0,250]]" type="text"
                               name="published_in" id="published_in"
                               value="<?php echo !empty($eventsInfo->published_in) ? $eventsInfo->published_in : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <div class="col-md-4" style="padding-left:0px !important;">
                            <input placeholder="Event Link" class="" type="text" name="linksrc" id="linksrc"
                                   value="<?php echo !empty($eventsInfo->linksrc) ? $eventsInfo->linksrc : ""; ?>">
                        </div>
                        <div class="col-md-6" style="padding-left:0px !important;">
                            <?php $Lpageview = !empty($eventsInfo->linksrc) ? $eventsInfo->linksrc : "";
                            $lnktype = !empty($eventsInfo->linktype) ? $eventsInfo->linktype : ""; ?>
                ...
                <!--<div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Video Link" class="col-md-6 validate[length[0,250]]" type="text"
                               name="brief" id="brief"
                               value="<?php //echo !empty($eventsInfo->brief) ? $eventsInfo->brief : ""; ?>">
                    </div>
                </div>-->
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        <input type="file" name="home_image" id="home_image" class="transparent no-shadow">
                         <label><small>Image Dimensions (395 px X 290 px)</small></label>
                    </div>
                ...
                <div class="form-row add-image">
                    ...
                    <!-- Upload user image preview -->
                    <div id="preview_Banner_Image"><input type="hidden" name="bannerimageArrayname[]"/></div>
                </div>

                <div class="form-row">
                    <?php
                    if (!empty($eventsInfo->banner_image)):
                        $imageRec = unserialize($eventsInfo->banner_image);
                        $deleteid = rand(1111, 99999);
                        if ($imageRec):
                            foreach ($imageRec as $imageRow): ?>
                                <div class="col-md-3" id="removeSavedimg<?php echo $deleteid; ?>">
                                    <div class="infobox info-bg">
                                        <div class="button-group" data-toggle="buttons">
                                    <span class="float-left">
                                        <?php
                                        if (file_exists(SITE_ROOT . "images/events/banner/" . $imageRow)):
                                            $filesize = filesize(SITE_ROOT . "images/events/banner/" . $imageRow);
                                            echo 'Size : ' . getFileFormattedSize($filesize);
                                        endif;
                                        ?>
                                    </span>
                                        ...
                                        <img src="<?php echo IMAGE_PATH . 'events/banner/thumbnails/' . $imageRow; ?>"
                                             style="width:100%"/>
                                        <input type="hidden" name="bannerimageArrayname[]" value="<?php echo $imageRow; ?>"/>
                                    </div>
                                </div>
                            <?php endforeach;
                        endif;
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <textarea placeholder="brief" class="col-md-8 validate[length[0,250]]" type="text" name="brief" 
        ...
        $(document).ready(function () {
            $('#home_image').uploadify({
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/events/uploaded_home_image.php', {imagefile: filename}, function (msg) {
            ...
            $('#banner_image').uploadify({
                ...
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/events/banner/',
                    thumb_width: 380,
                    thumb_height: 478
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    $.post('<?php echo BASE_URL;?>apanel/events/banner_image.php', {imagefile: filename}, function (msg) {
                        $('#preview_Banner_Image').append(msg).show();
                    });
