...
if (defined('MEMBER_LIST')) {
    $recRows = Member::find_all_active();
    // pr($recRows,1);
    if (!empty($recRows)) {
        ...
        $img = (file_exists($file_path) AND !empty($images[0])) ? IMAGE_PATH . 'member/banner/' . @$images[0] : BASE_URL . 'template/cms/images/default-member-image.jpeg';
